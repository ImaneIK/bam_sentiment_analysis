...
const TextForm = ({ title, text, displayedText, pubDate, handleTitleChange, handleChange, handlePubDate, handleSubmit, handleCancel, isDisabled }) => {
  return (
    ...
    <div className="flex flex-col xl:flex-row gap-8 text-center  xl:text-left w-full h-full p-12 lg:overflow-hidden bg-green-50">
          ...
          <div className="absolute flex flex-col ">
            ...
            {/* LEFT */}
            <div className="p-4 h-full bg-transparent flex-1 text-indigo-500 p-12 z-30">
              ...
              <ul className="text-xs text-justify list-disc m-6">
            ...
            {/* RIGHT */}
            <div className="z-30 w-full animate-fade-in duration-100 animate-slow editor bg-white rounded-md px-12 py-6 text-xs mx-auto flex-1 flex flex-col text-gray-800 border border-gray-300 shadow-lg ">
             ...
             <h3 className="text-xs font-semibold text-center my-6 text-gray-500">Fill in the form with the necessary infos</h3>
              ...
              <div className="buttons flex">
                ...
                <button
                  ...
                  disabled={isDisabled}
                  className={ !isDisabled ? "btn border border-indigo-500 rounded-md p-1 px-4 font-semibold cursor-pointer text-gray-200 ml-2 bg-indigo-500" : "bg-blue-200 border border-blue-500 rounded-md p-1 px-4 font-semibold cursor-pointer text-gray-200 ml-2"}
                >
                  Post
                </button>
              </div>
